...
import { 
  ...
  MODE_SNGL, MODE_MULT, RANK_EQ, RANK_AVG
...
export const FUNCTION_CATEGORIES = {
  ...
  statistics: [MEDIAN, MODE, COUNTA, COUNTBLANK, STDEV, VAR, LARGE, SMALL, RANK, CORREL, QUARTILE, PERCENTILE, GEOMEAN, HARMEAN, TRIMMEAN, MAXIFS, MINIFS, STDEV_S, STDEV_P, STDEVA, STDEVPA, VAR_S, VAR_P, VARA, VARPA, AVEDEV, DEVSQ, KURT, SKEW, SLOPE, INTERCEPT, RSQ, PEARSON, STEYX, FISHER, FISHERINV, MODE_SNGL, MODE_MULT, RANK_EQ, RANK_AVG] as CustomFormula[],
