...
【超重要：数式の必須化】
すべての計算を行うセルでは、必ず以下の形式を守ってください：
{"v": null, "f": "=関数名(引数)", "bg": "色コード", "fc": "文字色コード"}
- "v": 必ずnull（値は計算で求められるため）
- "f": 必ず数式を含める（=で始まるExcel形式）
- 数式フィールド"f"を省略すると、関数が実行されず#REF!エラーになります
...
**NPER関数の完全な例（重要）：**
{
  ...
  "spreadsheet_data": [
    ...
    [
      ...
      {"v": 1000, "ct": {"t": "n"}},
      {"v": 0, "ct": {"t": "n"}},
      {"v": null, "f": "=NPER(A2,B2,C2,D2)", "bg": "#FFFDE7", "fc": "#F57F17"},
      null, null, null
    ],
    [
      {"v": 0.04, "ct": {"t": "n"}},
      ...
      {"v": 500, "ct": {"t": "n"}},
      {"v": 0, "ct": {"t": "n"}},
      {"v": null, "f": "=NPER(A3,B3,C3,D3)", "bg": "#FFFDE7", "fc": "#F57F17"},
      null, null, null
    ],
    [
      {"v": 0.03, "ct": {"t": "n"}},
      ...
      {"v": 300, "ct": {"t": "n"}},
      {"v": 0, "ct": {"t": "n"}},
      {"v": null, "f": "=NPER(A4,B4,C4,D4)", "bg": "#FFFDE7", "fc": "#F57F17"},
      null, null, null
    ],
    [
      {"v": 0.06, "ct": {"t": "n"}},
      ...
      {"v": 1200, "ct": {"t": "n"}},
      {"v": 0, "ct": {"t": "n"}},
      {"v": null, "f": "=NPER(A5,B5,C5,D5)", "bg": "#FFFDE7", "fc": "#F57F17"},
      null, null, null
    ],
    [null, null, null, null, null, null, null, null],
    [null, null, null, null, null, null, null, null],
...
**プロジェクト管理表の完全な例（DATEDIF/NETWORKDAYS使用）：**
{
  ...
  "spreadsheet_data": [
    [
      ...
      {"v": "期間（日）", "ct": {"t": "s"}, "bg": "#F3E5F5"},
      {"v": "稼働日数", "ct": {"t": "s"}, "bg": "#F3E5F5"},
      {"v": "評価", "ct": {"t": "s"}, "bg": "#E8F5E8"},
      null, null
    ],
    [
      {"v": "プロジェクトA", "ct": {"t": "s"}},
      {"v": "2023-01-01", "ct": {"t": "s"}},
      {"v": "2023-01-10", "ct": {"t": "s"}},
      {"v": null, "f": "=DATEDIF(B2,C2,\"D\")", "bg": "#F3E5F5", "fc": "#7B1FA2"},
      {"v": null, "f": "=NETWORKDAYS(B2,C2)", "bg": "#F3E5F5", "fc": "#7B1FA2"},
      {"v": null, "f": "=IF(D2>=15,\"長期\",\"短期\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
      {"v": "プロジェクトB", "ct": {"t": "s"}},
      {"v": "2023-02-01", "ct": {"t": "s"}},
      {"v": "2023-02-20", "ct": {"t": "s"}},
      {"v": null, "f": "=DATEDIF(B3,C3,\"D\")", "bg": "#F3E5F5", "fc": "#7B1FA2"},
      {"v": null, "f": "=NETWORKDAYS(B3,C3)", "bg": "#F3E5F5", "fc": "#7B1FA2"},
      {"v": null, "f": "=IF(D3>=15,\"長期\",\"短期\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
      {"v": "プロジェクトC", "ct": {"t": "s"}},
      {"v": "2023-03-01", "ct": {"t": "s"}},
      {"v": "2023-03-08", "ct": {"t": "s"}},
      {"v": null, "f": "=DATEDIF(B4,C4,\"D\")", "bg": "#F3E5F5", "fc": "#7B1FA2"},
      {"v": null, "f": "=NETWORKDAYS(B4,C4)", "bg": "#F3E5F5", "fc": "#7B1FA2"},
      {"v": null, "f": "=IF(D4>=15,\"長期\",\"短期\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
      {"v": "合計", "ct": {"t": "s"}, "bg": "#FFE0B2"},
...
**KPIダッシュボード（売上・在庫管理）の完全な例：**
{
  "function_name": "IF & SUM & AVERAGE & COUNTIF",
  "description": "売上目標達成率、在庫管理、複数KPIを計算するダッシュボード",
  "syntax": "複数の関数を組み合わせて使用",
  "syntax_detail": "IF, SUM, AVERAGE, COUNTIFを組み合わせたKPI計算",
  "category": "ビジネス分析",
  "spreadsheet_data": [
    [
      {"v": "営業担当者", "ct": {"t": "s"}, "bg": "#E3F2FD"},
      {"v": "売上金額", "ct": {"t": "s"}, "bg": "#E3F2FD"},
      {"v": "売上評価", "ct": {"t": "s"}, "bg": "#E8F5E8"},
      {"v": "商品名", "ct": {"t": "s"}, "bg": "#E3F2FD"},
      {"v": "在庫数", "ct": {"t": "s"}, "bg": "#E3F2FD"},
      {"v": "在庫状況", "ct": {"t": "s"}, "bg": "#E8F5E8"},
      null, null
    ],
    [
      {"v": "田中", "ct": {"t": "s"}},
      ...
      {"v": "商品A", "ct": {"t": "s"}},
      {"v": 50, "ct": {"t": "n"}},
      {"v": null, "f": "=IF(E2<30,\"要発注\",\"充分\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
      {"v": "佐藤", "ct": {"t": "s"}},
      ...
      {"v": "商品B", "ct": {"t": "s"}},
      {"v": 20, "ct": {"t": "n"}},
      {"v": null, "f": "=IF(E3<30,\"要発注\",\"充分\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
      {"v": "鈴木", "ct": {"t": "s"}},
      ...
      {"v": "商品C", "ct": {"t": "s"}},
      {"v": 10, "ct": {"t": "n"}},
      {"v": null, "f": "=IF(E4<30,\"要発注\",\"充分\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
      {"v": "山田", "ct": {"t": "s"}},
      ...
      {"v": "商品D", "ct": {"t": "s"}},
      {"v": 30, "ct": {"t": "n"}},
      {"v": null, "f": "=IF(E5<30,\"要発注\",\"充分\")", "bg": "#E8F5E8", "fc": "#2E7D32"},
      null, null
    ],
    [
...
**重要な注意事項：**
- 数式のセル参照は必ず正しい列を指定してください
- 売上評価は売上金額（B列）を参照: =IF(B2>=100000,"目標達成","要改善")
- 在庫状況は在庫数（E列）を参照: =IF(E2<30,"要発注","充分") 
- #REF!エラーを避けるため、存在する列のみを参照してください
- **NETWORKDAYS関数を使用する場合**: 必ず {"v": null, "f": "=NETWORKDAYS(開始日セル,終了日セル)", "bg": "#F3E5F5", "fc": "#7B1FA2"} の形式で数式を含めてください
- **重要**: NETWORKDAYSの数式が抜けていると、計算結果が表示されません
- **すべての数式セル必須**: {"v": null, "f": "=数式"} の形式で、"v"はnull、"f"に数式を必ず含める
- **絶対に守ること**: 数式を使うセルでは "f" フィールドを省略しない。省略すると #REF! エラーになります
